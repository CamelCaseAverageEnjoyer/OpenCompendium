...
X_1(1:3,1) = A_incl*X_1(1:3,1); % Inclined reference frame
X_1(4:6,1) = A_incl*X_1(4:6,1);
...
X_2(1:3,1) = A_incl*X_2(1:3,1); % Inclined reference frame
X_2(4:6,1) = A_incl*X_2(4:6,1);
...
X_3(1:3,1) = A_incl*X_3(1:3,1); % Inclined reference frame
X_3(4:6,1) = A_incl*X_3(4:6,1);
...
for i = 2:1:length(T) 
    ...
    if rem(i,int16(length(T)/500))==0 %% Annimation is plotted each length(T)/500 steps
        ...
        plot3(xsat_diff_12(1,i),xsat_diff_12(2,i),xsat_diff_12(3,i),'ob','LineWidth',4)
        plot3(xsat_diff_13(1,i),xsat_diff_13(2,i),xsat_diff_13(3,i),'og','LineWidth',4)
